...
```
┌─ Расписание ── Необработанные (4) ──────────────────────────────────────────┐
│  ‹  25.07.2026  Сегодня  ›     поиск…     [+ Новый]  [⟳]  [⚙]              │
├─────────────────────────────────────────────────────────┬───────────────────┤
│ 09:00                                                   │  Иван Соколов     │
│ 09:30  ┌──────────┐                                     │  AB3K9 · site     │
│ 10:00  │Иван ☎✉  │ │Марина ☎│ │Пётр A.│   ← 3 в слоте │                   │
│ 10:30                                                   │  ☎ Обзвонили      │
│ 11:00  ┌──────────┐                                     │  ✉ SMS отправлено │
│  ...   │Сергей    │                                     │  [Редактировать]  │
└─────────────────────────────────────────────────────────┴───────────────────┘
```

> Позже можно положить скриншоты в `docs/screenshots/day.png` и `inbox.png`.
...
Автор: [duryagin228777666-lab](https://github.com/duryagin228777666-lab) · сервис: шиномонтаж «Низкий профиль», Москва
